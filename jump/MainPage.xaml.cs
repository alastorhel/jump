...
public partial class MainPage : ContentPage
{
	...
	protected override void OnSizeAllocated(double w, double h)
	{
		...
		inimigos.Add(new Inimigo(imgpedra));
		inimigos.Add(new Inimigo(imgcacador));
		inimigos.Add(new Inimigo(imgfoguinho));
		inimigos.Add(new Inimigo(imgarmadilha));
	}
